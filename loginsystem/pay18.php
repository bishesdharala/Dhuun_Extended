...
<link href="css/pay18.css" rel='stylesheet' type='text/css' />
	 ...
	 <div class="sap_tabs">	
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
			  <ul class="resp-tabs-list">			  	  	
				  ...
				  <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><div class="top-img"><img src="images/top-lock.png" alt=""/></div><span>Your Total = 18$</span></li>
				  <div class="clear"></div>
			  </ul>		
